...
export interface WcAdminOnboardingPluginsInstallAsyncPostArgsPlugins {}

export interface WcAdminOnboardingPluginsInstallAsyncPostArgs {
  /** A list of plugins to install */
  plugins: WcAdminOnboardingPluginsInstallAsyncPostArgsPlugins[];
}
...
export interface WcAdminPostRoutes {
  ...
  '/wc-admin/onboarding/plugins/install-async': WcAdminOnboardingPluginsInstallAsyncPostArgs;
  '/wc-admin/onboarding/profile': WcAdminOnboardingProfilePostPutPatchArgs;
