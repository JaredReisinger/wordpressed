...
> Snapshot 4
    ...
    ␊
    // WordPress REST API "test" responses␊
    ␊
    /**␊
     * Response for \`/test\` route when calling GET method.␊
     */␊
